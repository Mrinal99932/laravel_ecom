...
Route::get('cartdelete/{id}',[FrontController::class,'cartdelete']);
Route::get('checkout',[FrontController::class,'checkout']);

Route::post('dologin',[FrontController::class,'dologin']);
Route::get('registration',[FrontController::class,'registration']);
Route::post('adduser',[FrontController::class,'adduser']);
